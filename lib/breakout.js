...
function drawHighScore() {
  ctx.font = "20px VT323";
  ctx.fillStyle = "#e60000";
  ctx.fillText("HIGH SCORE: "+highScore, canvas.width-140, 70);
}
...
//     ctx.fillText("Great! ready for Level "+level+"? (press Up Arrow)",
//                   canvas.width/2 - 350, canvas.height/2);
//    }
// }
...
function drawGameOver(){
  ...
  ctx.fillText("Game Over (press N to start new game)",
                canvas.width/2 - 230, canvas.height/2);
}
...
function drawWelcome(){
  ...
  ctx.font = "30px VT323";
  ctx.fillStyle = "#e60000";
  ctx.fillText("BREAKOUT! PRESS ENTER TO START",
                canvas.width/2 - 190, canvas.height/2);
